...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        input_para = new QAction(MainWindow);
        input_para->setObjectName(QStringLiteral("input_para"));
        input_para->setEnabled(false);
        input_para->setFont(font);
        ...
        input_data = new QAction(MainWindow);
        input_data->setObjectName(QStringLiteral("input_data"));
        input_data->setEnabled(false);
        import_data = new QAction(MainWindow);
        ...
        view_para = new QAction(MainWindow);
        view_para->setObjectName(QStringLiteral("view_para"));
        view_para->setEnabled(false);
        modify_para = new QAction(MainWindow);
        modify_para->setObjectName(QStringLiteral("modify_para"));
        modify_para->setEnabled(false);
        ...
        import_para = new QAction(MainWindow);
        import_para->setObjectName(QStringLiteral("import_para"));
        import_para->setEnabled(false);
        ...
        caculate_para = new QMenu(base_parameter);
        caculate_para->setObjectName(QStringLiteral("caculate_para"));
        caculate_para->setEnabled(false);
        menu_2 = new QMenu(caculate_para);
        menu_2->setObjectName(QStringLiteral("menu_2"));
        menu_3 = new QMenu(caculate_para);
        menu_3->setObjectName(QStringLiteral("menu_3"));
        menu_4 = new QMenu(caculate_para);
        menu_4->setObjectName(QStringLiteral("menu_4"));
        menu_5 = new QMenu(caculate_para);
        menu_5->setObjectName(QStringLiteral("menu_5"));
        menu_7 = new QMenu(caculate_para);
        menu_7->setObjectName(QStringLiteral("menu_7"));
        menu_8 = new QMenu(caculate_para);
        ...
        File->addAction(exit);
        base_parameter->addAction(input_para);
        base_parameter->addAction(import_para);
        base_parameter->addSeparator();
        base_parameter->addAction(caculate_para->menuAction());
        base_parameter->addSeparator();
        base_parameter->addAction(view_para);
        base_parameter->addAction(modify_para);
        caculate_para->addAction(menu_2->menuAction());
        caculate_para->addAction(menu_3->menuAction());
        caculate_para->addSeparator();
        caculate_para->addAction(menu_4->menuAction());
        caculate_para->addAction(menu_5->menuAction());
        caculate_para->addSeparator();
        caculate_para->addAction(menu_7->menuAction());
        caculate_para->addAction(menu_8->menuAction());
        ...
        base_data->addAction(input_data);
        base_data->addAction(import_data);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        input_para->setText(QApplication::translate("MainWindow", "\345\275\225\345\205\245", 0));
        ...
        input_data->setText(QApplication::translate("MainWindow", "\345\275\225\345\205\245", 0));
        import_data->setText(QApplication::translate("MainWindow", "\345\257\274\345\205\245", 0));
        ...
        view_para->setText(QApplication::translate("MainWindow", "\346\237\245\347\234\213", 0));
        modify_para->setText(QApplication::translate("MainWindow", "\344\277\256\346\224\271", 0));
        ...
        import_para->setText(QApplication::translate("MainWindow", "\345\257\274\345\205\245", 0));
        ...
        caculate_para->setTitle(QApplication::translate("MainWindow", "\350\256\241\347\256\227", 0));
